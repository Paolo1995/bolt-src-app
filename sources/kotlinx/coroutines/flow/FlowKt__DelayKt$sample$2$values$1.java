...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", f = "Delay.kt", l = {280}, m = "invokeSuspend")
...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    private /* synthetic */ Object f51503h;

    /* renamed from: i  reason: collision with root package name */
    final /* synthetic */ Flow<T> f51504i;
    ...
    public static final class AnonymousClass1<T> implements FlowCollector {
        ...
        final /* synthetic */ ProducerScope<Object> f51505f;

        AnonymousClass1(ProducerScope<Object> producerScope) {
            this.f51505f = producerScope;
        }
        ...
        */
        public final java.lang.Object b(T r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
            ...
            L13:
                ...
                r0.<init>(r4, r6)
            L18:
                java.lang.Object r6 = r0.f51506f
            ...
            L31:
                kotlin.ResultKt.b(r6)
                kotlinx.coroutines.channels.ProducerScope<java.lang.Object> r6 = r4.f51505f
                if (r5 != 0) goto L3a
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        FlowKt__DelayKt$sample$2$values$1 flowKt__DelayKt$sample$2$values$1 = new FlowKt__DelayKt$sample$2$values$1(this.f51504i, continuation);
        flowKt__DelayKt$sample$2$values$1.f51503h = obj;
    ...
    public final Object s(ProducerScope<Object> producerScope, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$sample$2$values$1) create(producerScope, continuation)).invokeSuspend(Unit.f50853a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            ResultKt.b(obj);
            Flow<T> flow = this.f51504i;
            AnonymousClass1 anonymousClass1 = new AnonymousClass1((ProducerScope) this.f51503h);
            this.f51502g = 1;
