...
public final class CharMappings {
    ...
    public static final CharMappings f52375a;

    /* renamed from: b  reason: collision with root package name */
    public static final char[] f52376b;

    /* renamed from: c  reason: collision with root package name */
    public static final byte[] f52377c;

    static {
        CharMappings charMappings = new CharMappings();
        f52375a = charMappings;
        f52376b = new char[117];
        f52377c = new byte[126];
        charMappings.f();
        charMappings.e();
    }
