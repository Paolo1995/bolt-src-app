...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z7) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            tlsVersionsIntersection = Util.intersect(enabledProtocols, strArr, b8);
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        if (z7 && (!Arrays.equals(this.cipherSuitesAsString, connectionSpec.cipherSuitesAsString) || !Arrays.equals(this.tlsVersionsAsString, connectionSpec.tlsVersionsAsString) || this.supportsTlsExtensions != connectionSpec.supportsTlsExtensions)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        if (this.isTls) {
            ...
            return ((i9 + i8) * 31) + (!this.supportsTlsExtensions ? 1 : 0);
        }
        return 17;
    }
