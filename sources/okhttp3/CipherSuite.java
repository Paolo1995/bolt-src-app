...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        public final CipherSuite init(String str, int i8) {
        ...
        private final String secondaryName(String str) {
            boolean L;
            boolean L2;
            L = StringsKt__StringsJVMKt.L(str, "TLS_", false, 2, null);
            if (L) {
                String substring = str.substring(4);
                Intrinsics.e(substring, "this as java.lang.String).substring(startIndex)");
                return Intrinsics.n("SSL_", substring);
            }
            L2 = StringsKt__StringsJVMKt.L(str, "SSL_", false, 2, null);
            if (L2) {
                String substring2 = str.substring(4);
                Intrinsics.e(substring2, "this as java.lang.String).substring(startIndex)");
                return Intrinsics.n("TLS_", substring2);
            }
            return str;
        }
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String a8, String b8) {
                Intrinsics.f(a8, "a");
                Intrinsics.f(b8, "b");
                int min = Math.min(a8.length(), b8.length());
    ...
    public final String m39deprecated_javaName() {
