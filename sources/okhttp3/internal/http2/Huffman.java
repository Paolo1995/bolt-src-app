...
public final class Huffman {
    ...
    static {
        ...
        for (int i8 = 0; i8 < length; i8++) {
            INSTANCE.addCode(i8, CODES[i8], CODE_BIT_COUNTS[i8]);
        }
    }
    ...
    private final void addCode(int i8, int i9, int i10) {
        Node node = new Node(i8, i10);
        Node node2 = root;
        while (i10 > 8) {
            i10 -= 8;
            int i11 = (i9 >>> i10) & 255;
        ...
        ArraysKt___ArraysJvmKt.m(children2, node, i13, (1 << i12) + i13);
    }

    public final void decode(BufferedSource source, long j8, BufferedSink sink) {
        ...
        while (j9 < j8) {
            j9++;
            i8 = (i8 << 8) | Util.and(source.readByte(), 255);
            i9 += 8;
            while (i9 >= 8) {
                Node[] children = node.getChildren();
                Intrinsics.c(children);
                node = children[(i8 >>> (i9 - 8)) & 255];
                Intrinsics.c(node);
                if (node.getChildren() == null) {
                    sink.writeByte(node.getSymbol());
                    i9 -= node.getTerminalBitCount();
                    node = root;
                } else {
                    i9 -= 8;
                }
        ...
        while (i9 > 0) {
            ...
            Intrinsics.c(children2);
            Node node2 = children2[(i8 << (8 - i9)) & 255];
            Intrinsics.c(node2);
            if (node2.getChildren() == null && node2.getTerminalBitCount() <= i9) {
                sink.writeByte(node2.getSymbol());
                i9 -= node2.getTerminalBitCount();
                node = root;
            } else {
                return;
            }
    ...
    public final void encode(ByteString source, BufferedSink sink) throws IOException {
        ...
        while (i8 < z7) {
            int i10 = i8 + 1;
            int and = Util.and(source.h(i8), 255);
            int i11 = CODES[and];
            byte b8 = CODE_BIT_COUNTS[and];
            j8 = (j8 << b8) | i11;
            i9 += b8;
            while (i9 >= 8) {
                i9 = (i9 == true ? 1 : 0) - 8;
        ...
        if (i9 > 0) {
            sink.writeByte((int) ((j8 << (8 - i9)) | (255 >>> i9)));
        }
    }
    ...
    public final int encodedLength(ByteString bytes) {
        ...
        while (i8 < z7) {
            int i9 = i8 + 1;
            j8 += CODE_BIT_COUNTS[Util.and(bytes.h(i8), 255)];
            i8 = i9;
        }
        return (int) ((j8 + 7) >> 3);
    }
    ...
    public static final class Node {
        ...
        public Node() {
            this.children = new Node[Spliterator.NONNULL];
            this.symbol = 0;
        ...
        public Node(int i8, int i9) {
            ...
            this.symbol = i8;
            int i10 = i9 & 7;
            this.terminalBitCount = i10 == 0 ? 8 : i10;
        }
    }
}
