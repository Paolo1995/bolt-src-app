...
public final class ObservableLiveData<T> extends LiveData<T> implements Disposable {
    ...
    public static /* synthetic */ void t(ObservableLiveData observableLiveData, Observable observable, Function1 function1, Function1 function12, int i8, Object obj) {
        if ((i8 & 2) != 0) {
            function1 = new Function1<T, Unit>() { // from class: eu.bolt.driver.core.ui.common.lifecycle.ObservableLiveData$subscribe$1
    ...
    public void dispose() {
        Disposable disposable = this.f41117q;
        if (disposable != null) {
            disposable.dispose();
        }
    }
    ...
    public final void s(Observable<T> source, final Function1<? super T, Unit> valueHandler, final Function1<? super Throwable, Unit> errorHandler) {
        ...
        if (this.f41117q == null) {
            final Function1<T, Unit> function1 = new Function1<T, Unit>(this) { // from class: eu.bolt.driver.core.ui.common.lifecycle.ObservableLiveData$subscribe$2

                /* renamed from: f  reason: collision with root package name */
                final /* synthetic */ ObservableLiveData<T> f41119f;
            ...
            Consumer<? super T> consumer = new Consumer() { // from class: eu.bolt.driver.core.ui.common.lifecycle.b
                @Override // io.reactivex.functions.Consumer
                public final void accept(Object obj) {
                    ObservableLiveData.u(Function1.this, obj);
                }
            };
            final Function1<Throwable, Unit> function12 = new Function1<Throwable, Unit>() { // from class: eu.bolt.driver.core.ui.common.lifecycle.ObservableLiveData$subscribe$3
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
            ...
            this.f41117q = source.subscribe(consumer, new Consumer() { // from class: eu.bolt.driver.core.ui.common.lifecycle.c
                @Override // io.reactivex.functions.Consumer
                public final void accept(Object obj) {
