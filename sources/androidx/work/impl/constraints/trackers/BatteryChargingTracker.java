...
public class BatteryChargingTracker extends BroadcastReceiverConstraintTracker<Boolean> {
    ...
    private static final String f8530i = Logger.f("BatteryChrgTracker");
    ...
    */
    public void h(android.content.Context r6, @androidx.annotation.NonNull android.content.Intent r7) {
        ...
        L7:
            ...
            java.lang.String r0 = androidx.work.impl.constraints.trackers.BatteryChargingTracker.f8530i
            r1 = 1
        ...
        L6c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.constraints.trackers.BatteryChargingTracker.h(android.content.Context, android.content.Intent):void");
    }
    ...
    public Boolean b() {
        ...
        if (registerReceiver == null) {
            Logger.c().b(f8530i, "getInitialState - null intent received", new Throwable[0]);
            return null;
        }
