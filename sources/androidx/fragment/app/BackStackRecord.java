...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public void bumpBackStackNesting(int i8) {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            Fragment fragment = this.mOps.get(i9).mFragment;
            if (fragment != null) {
    ...
    int commitInternal(boolean z7) {
        if (!this.mCommitted) {
            ...
            this.mManager.enqueueAction(this, z7);
            return this.mIndex;
        }
                ...
                if (i9 != 2) {
                    if (i9 != 3 && i9 != 6) {
                        ...
                        if (fragment3 == fragment2) {
                            this.mOps.add(i8, new FragmentTransaction.Op(9, fragment3));
                            i8++;
                            fragment2 = null;
                        }
                    }
                        ...
                        if (fragment5.mContainerId == i10) {
                            if (fragment5 == fragment4) {
                                ...
                                if (fragment5 == fragment2) {
                                    this.mOps.add(i8, new FragmentTransaction.Op(9, fragment5, true));
                                    i8++;
                                    fragment2 = null;
                                }
                                FragmentTransaction.Op op2 = new FragmentTransaction.Op(3, fragment5, true);
