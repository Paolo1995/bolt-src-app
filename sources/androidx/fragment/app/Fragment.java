...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner {
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> activityResultContract, @NonNull final Function<Void, ActivityResultRegistry> function, @NonNull final ActivityResultCallback<O> activityResultCallback) {
        if (this.mState <= 1) {
            ...
            registerOnPreAttachListener(new OnPreAttachedListener() { // from class: androidx.fragment.app.Fragment.9
                ...
                @Override // androidx.fragment.app.Fragment.OnPreAttachedListener
                void onPreAttached() {
                    atomicReference.set(((ActivityResultRegistry) function.apply(null)).j(Fragment.this.generateActivityResultKey(), Fragment.this, activityResultContract, activityResultCallback));
                }
            });
    ...
    public CreationExtras getDefaultViewModelCreationExtras() {
        ...
        if (getArguments() != null) {
            mutableCreationExtras.c(SavedStateHandleSupport.f6760c, getArguments());
        }
    ...
    public void setAllowEnterTransitionOverlap(boolean z7) {
        ensureAnimationInfo().mAllowEnterTransitionOverlap = Boolean.valueOf(z7);
    }

    public void setAllowReturnTransitionOverlap(boolean z7) {
        ensureAnimationInfo().mAllowReturnTransitionOverlap = Boolean.valueOf(z7);
    }
    ...
    public void setPopDirection(boolean z7) {
        ...
        ensureAnimationInfo().mIsPop = z7;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setPostOnViewCreatedAlpha(float f8) {
        ensureAnimationInfo().mPostOnViewCreatedAlpha = f8;
    }
    ...
    public void setUserVisibleHint(boolean z7) {
        boolean z8;
        FragmentStrictMode.onSetUserVisibleHint(this, z7);
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        ...
        if (fragmentHostCallback != null) {
            ...
            LayoutInflaterCompat.a(onGetLayoutInflater, this.mChildFragmentManager.getLayoutInflaterFactory());
            return onGetLayoutInflater;
        }
