...
public class FragmentStateManager {
    ...
    void createView() {
        ...
        if (view != null) {
            ...
            Fragment fragment5 = this.mFragment;
            fragment5.mView.setTag(R$id.f6627a, fragment5);
            if (viewGroup != null) {
                addViewToContainer();
            }
            ...
            if (ViewCompat.V(this.mFragment.mView)) {
                ViewCompat.p0(this.mFragment.mView);
            } else {
    ...
    void destroy() {
        ...
        if (!z7 && !this.mFragmentStore.getNonConfig().shouldDestroy(this.mFragment)) {
            z8 = false;
        } else {
            z8 = true;
        }
        if (z8) {
            ...
            if ((z7 && !this.mFragment.mBeingSaved) || z9) {
    ...
    public void ensureInflatedView() {
        ...
        if (fragment.mFromLayout && fragment.mInLayout && !fragment.mPerformedCreateView) {
            ...
            if (view != null) {
                view.setSaveFromParentEnabled(false);
                Fragment fragment3 = this.mFragment;
                fragment3.mView.setTag(R$id.f6627a, fragment3);
                Fragment fragment4 = this.mFragment;
        ...
        try {
            ...
            while (true) {
                ...
                if (computeExpectedState != i8) {
                    ...
                    if (!z7 && i8 == -1 && fragment.mRemoving && !fragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                        if (FragmentManager.isLoggingEnabled(3)) {
