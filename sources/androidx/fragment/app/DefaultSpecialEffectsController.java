...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    public static class AnimationInfo extends SpecialEffectsInfo {
        ...
        FragmentAnim.AnimationOrAnimator getAnimation(@NonNull Context context) {
            ...
            FragmentAnim.AnimationOrAnimator loadAnimation = FragmentAnim.loadAnimation(context, fragment, z7, this.mIsPop);
    ...
    private void startAnimations(@NonNull List<AnimationInfo> list, @NonNull List<SpecialEffectsController.Operation> list2, boolean z7, @NonNull Map<SpecialEffectsController.Operation, Boolean> map) {
        int i8;
        boolean z8;
        boolean z9;
                ...
                if (animation == null) {
                    ...
                    if (animator == null) {
                        ...
                        if (Boolean.TRUE.equals(map.get(operation2))) {
                            ...
                            next.getSignal().b(new CancellationSignal.OnCancelListener() { // from class: androidx.fragment.app.DefaultSpecialEffectsController.3
        ...
        while (it2.hasNext()) {
            ...
            if (z7) {
                ...
                Animation animation2 = (Animation) Preconditions.g(((FragmentAnim.AnimationOrAnimator) Preconditions.g(animationInfo.getAnimation(context))).animation);
                ...
                animationInfo.getSignal().b(new CancellationSignal.OnCancelListener() { // from class: androidx.fragment.app.DefaultSpecialEffectsController.5
                    @Override // androidx.core.os.CancellationSignal.OnCancelListener
                    public void onCancel() {
    ...
    @NonNull
    private Map<SpecialEffectsController.Operation, Boolean> startTransitions(@NonNull List<TransitionInfo> list, @NonNull List<SpecialEffectsController.Operation> list2, final boolean z7, final SpecialEffectsController.Operation operation, final SpecialEffectsController.Operation operation2) {
        String str;
        View next;
        View next2;
        boolean z8;
        ...
        while (true) {
            ...
            if (next3.hasSharedElementTransition() && operation6 != null && operation7 != null) {
                ...
                arrayMap3.p(sharedElementSourceNames);
                if (enterTransitionCallback != null) {
                    ...
                    while (size2 >= 0) {
                        ...
                        if (view10 == null) {
                            ...
                            arrayList6 = sharedElementSourceNames;
                            if (!str4.equals(ViewCompat.M(view10))) {
                                arrayMap2.put(ViewCompat.M(view10), (String) arrayMap2.remove(str4));
                            }
                        }
                        size2--;
                    ...
                    arrayList5 = sharedElementSourceNames;
                    arrayMap2.p(arrayMap3.keySet());
                }
                final ArrayMap<String, View> arrayMap4 = new ArrayMap<>();
                findNamedViews(arrayMap4, operation2.getFragment().mView);
                arrayMap4.p(sharedElementTargetNames2);
                arrayMap4.p(arrayMap2.values());
                if (exitTransitionCallback != null) {
                    ...
                    for (int size3 = sharedElementTargetNames2.size() - 1; size3 >= 0; size3--) {
                        ...
                        } else if (!str5.equals(ViewCompat.M(view11)) && (findKeyForValue = FragmentTransition.findKeyForValue(arrayMap2, str5)) != null) {
                            arrayMap2.put(findKeyForValue, ViewCompat.M(view11));
                        }
                    }
                } else {
                ...
                if (arrayMap2.isEmpty()) {
                    ...
                    OneShotPreDrawListener.a(getContainer(), new Runnable() { // from class: androidx.fragment.app.DefaultSpecialEffectsController.6
                        @Override // java.lang.Runnable
                        public void run() {
                            FragmentTransition.callSharedElementStartEnd(operation2.getFragment(), operation.getFragment(), z7, arrayMap4, false);
                        }
                    });
                    ...
                    if (!sharedElementTargetNames2.isEmpty() && (view5 = arrayMap4.get(sharedElementTargetNames2.get(i8))) != null) {
                        rect = rect3;
                        OneShotPreDrawListener.a(getContainer(), new Runnable() { // from class: androidx.fragment.app.DefaultSpecialEffectsController.7
                            @Override // java.lang.Runnable
                            public void run() {
        ...
        for (TransitionInfo transitionInfo3 : list) {
            if (transitionInfo3.isVisibilityUnchanged()) {
                ...
                if (obj4 != null && (operation10 == operation8 || operation10 == operation9)) {
                    z9 = true;
                } else {
                    z9 = false;
                }
                if (cloneTransition == null) {
                    ...
                    if (arrayList12.isEmpty()) {
                        ...
                        if (operation10.getFinalState() == SpecialEffectsController.Operation.State.GONE) {
                            ...
                            OneShotPreDrawListener.a(getContainer(), new Runnable() { // from class: androidx.fragment.app.DefaultSpecialEffectsController.8
                                @Override // java.lang.Runnable
                                public void run() {
        ...
        for (final TransitionInfo transitionInfo4 : list) {
            if (!transitionInfo4.isVisibilityUnchanged()) {
                ...
                if (obj4 != null && (operation11 == operation8 || operation11 == operation9)) {
                    z8 = true;
                } else {
                    z8 = false;
                }
                if (transition == null && !z8) {
                    str2 = str6;
                } else if (!ViewCompat.W(getContainer())) {
                    if (FragmentManager.isLoggingEnabled(2)) {
                        str2 = str6;
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            ...
            while (it4.hasNext()) {
                Log.v(str7, "View: " + it4.next() + " Name: " + ViewCompat.M(next2));
            }
            Log.v(str7, ">>>>> SharedElementLastInViews <<<<<");
            Iterator<View> it5 = arrayList15.iterator();
            while (it5.hasNext()) {
                Log.v(str7, "View: " + it5.next() + " Name: " + ViewCompat.M(next));
            }
        }
    ...
    void executeOperations(@NonNull List<SpecialEffectsController.Operation> list, boolean z7) {
        ...
        for (SpecialEffectsController.Operation operation3 : list) {
            ...
            if (i8 != 1 && i8 != 2 && i8 != 3) {
                if (i8 == 4 && from != SpecialEffectsController.Operation.State.VISIBLE) {
        ...
        for (final SpecialEffectsController.Operation operation4 : list) {
            ...
            arrayList.add(new AnimationInfo(operation4, cancellationSignal, z7));
            CancellationSignal cancellationSignal2 = new CancellationSignal();
            operation4.markStartedSpecialEffect(cancellationSignal2);
            boolean z8 = false;
            if (z7) {
                if (operation4 != operation) {
                    arrayList2.add(new TransitionInfo(operation4, cancellationSignal2, z7, z8));
        ...
        Map<SpecialEffectsController.Operation, Boolean> startTransitions = startTransitions(arrayList2, arrayList3, z7, operation, operation2);
    ...
    void retainMatchingViews(@NonNull ArrayMap<String, View> arrayMap, @NonNull Collection<String> collection) {
        ...
        while (it.hasNext()) {
            if (!collection.contains(ViewCompat.M(it.next().getValue()))) {
                it.remove();
            }
        }
    }
