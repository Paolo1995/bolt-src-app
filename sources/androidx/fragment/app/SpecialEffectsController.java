...
public abstract class SpecialEffectsController {
    ...
    abstract void executeOperations(@NonNull List<Operation> list, boolean z7);
    ...
    public void executePendingOperations() {
        ...
        if (!ViewCompat.V(this.mContainer)) {
    ...
    public void forceCompleteAllOperations() {
        ...
        boolean V = ViewCompat.V(this.mContainer);
        synchronized (this.mPendingOperations) {
            updateFinalState();
            Iterator<Operation> it = this.mPendingOperations.iterator();
            while (it.hasNext()) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void updateOperationDirection(boolean z7) {
        this.mOperationDirectionIsPop = z7;
    }
    ...
    public static SpecialEffectsController getOrCreateController(@NonNull ViewGroup viewGroup, @NonNull SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        ...
        viewGroup.setTag(i8, createController);
