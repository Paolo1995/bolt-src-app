...
public class FragmentLifecycleCallbacksDispatcher {
    ...
    public static final class FragmentLifecycleCallbacksHolder {
        ...
        FragmentLifecycleCallbacksHolder(@NonNull FragmentManager.FragmentLifecycleCallbacks fragmentLifecycleCallbacks, boolean z7) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentActivityCreated(@NonNull Fragment fragment, Bundle bundle, boolean z7) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentAttached(@NonNull Fragment fragment, boolean z7) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentCreated(@NonNull Fragment fragment, Bundle bundle, boolean z7) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentDestroyed(@NonNull Fragment fragment, boolean z7) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentDetached(@NonNull Fragment fragment, boolean z7) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentPaused(@NonNull Fragment fragment, boolean z7) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentPreAttached(@NonNull Fragment fragment, boolean z7) {
        Context context = this.mFragmentManager.getHost().getContext();
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentPreCreated(@NonNull Fragment fragment, Bundle bundle, boolean z7) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentResumed(@NonNull Fragment fragment, boolean z7) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentSaveInstanceState(@NonNull Fragment fragment, @NonNull Bundle bundle, boolean z7) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentStarted(@NonNull Fragment fragment, boolean z7) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentStopped(@NonNull Fragment fragment, boolean z7) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentViewCreated(@NonNull Fragment fragment, @NonNull View view, Bundle bundle, boolean z7) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void dispatchOnFragmentViewDestroyed(@NonNull Fragment fragment, boolean z7) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void registerFragmentLifecycleCallbacks(@NonNull FragmentManager.FragmentLifecycleCallbacks fragmentLifecycleCallbacks, boolean z7) {
        this.mLifecycleCallbacks.add(new FragmentLifecycleCallbacksHolder(fragmentLifecycleCallbacks, z7));
    }
    ...
    public void unregisterFragmentLifecycleCallbacks(@NonNull FragmentManager.FragmentLifecycleCallbacks fragmentLifecycleCallbacks) {
        synchronized (this.mLifecycleCallbacks) {
            ...
            while (true) {
                if (i8 >= size) {
                    break;
                } else if (this.mLifecycleCallbacks.get(i8).mCallback == fragmentLifecycleCallbacks) {
