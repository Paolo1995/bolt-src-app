...
public class Room {
    ...
    @NonNull
    public static <T, C> T b(@NonNull Class<C> cls, @NonNull String str) {
        String str2;
    ...
    @NonNull
    public static <T extends RoomDatabase> RoomDatabase.Builder<T> c(@NonNull Context context, @NonNull Class<T> cls) {
