...
class TransitionUtils {
    ...
    private static final boolean f7873b;

    /* renamed from: c  reason: collision with root package name */
    private static final boolean f7874c;
    ...
    public static View a(ViewGroup viewGroup, View view, View view2) {
        ...
        ViewUtils.i(view, matrix);
        ViewUtils.j(viewGroup, matrix);
        ...
        imageView.measure(View.MeasureSpec.makeMeasureSpec(round3 - round, Pow2.MAX_POW2), View.MeasureSpec.makeMeasureSpec(round4 - round2, Pow2.MAX_POW2));
    ...
    */
    private static android.graphics.Bitmap b(android.view.View r9, android.graphics.Matrix r10, android.graphics.RectF r11, android.view.ViewGroup r12) {
        /*
            boolean r0 = androidx.transition.TransitionUtils.f7872a
            r1 = 0
            if (r0 == 0) goto L13
        ...
        L14:
            r2 = 0
        L15:
            boolean r3 = androidx.transition.TransitionUtils.f7873b
            r4 = 0
            if (r3 == 0) goto L31
            if (r0 == 0) goto L31
            if (r2 != 0) goto L1f
        ...
        L33:
            ...
            r10.postScale(r4, r4)
            boolean r11 = androidx.transition.TransitionUtils.f7874c
            if (r11 == 0) goto L88
            ...
            r9.draw(r4)
            r11.endRecording()
            android.graphics.Bitmap r4 = androidx.transition.a.a(r11)
            goto L99
        L88:
