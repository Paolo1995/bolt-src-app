...
final class Utils {
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public String toString() {
            ...
            for (int i8 = 1; i8 < this.typeArguments.length; i8++) {
                sb.append(", ");
                sb.append(Utils.typeToString(this.typeArguments[i8]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class WildcardTypeImpl implements WildcardType {
        ...
        public int hashCode() {
            ...
            return i8 ^ (this.upperBound.hashCode() + 31);
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Type getParameterLowerBound(int i8, ParameterizedType parameterizedType) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static RuntimeException parameterError(Method method, Throwable th, int i8, String str, Object... objArr) {
        return methodError(method, th, str + " (parameter #" + (i8 + 1) + ")", objArr);
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static RuntimeException parameterError(Method method, int i8, String str, Object... objArr) {
        return methodError(method, str + " (parameter #" + (i8 + 1) + ")", objArr);
    }
}
