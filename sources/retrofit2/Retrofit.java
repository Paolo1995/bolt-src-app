...
public final class Retrofit {
    ...
    Retrofit(Call.Factory factory, HttpUrl httpUrl, List<Converter.Factory> list, List<CallAdapter.Factory> list2, @Nullable Executor executor, boolean z7) {
    ...
    public CallAdapter<?, ?> nextCallAdapter(@Nullable CallAdapter.Factory factory, Type type, Annotation[] annotationArr) {
        ...
        for (int i8 = indexOf; i8 < size; i8++) {
            CallAdapter<?, ?> callAdapter = this.callAdapterFactories.get(i8).get(type, annotationArr, this);
            if (callAdapter != null) {
                return callAdapter;
            }
        }
    ...
    public <T> Converter<T, RequestBody> nextRequestBodyConverter(@Nullable Converter.Factory factory, Type type, Annotation[] annotationArr, Annotation[] annotationArr2) {
        ...
        for (int i8 = indexOf; i8 < size; i8++) {
            Converter<T, RequestBody> converter = (Converter<T, RequestBody>) this.converterFactories.get(i8).requestBodyConverter(type, annotationArr, annotationArr2, this);
            if (converter != null) {
                return converter;
            }
        }
    ...
    public <T> Converter<ResponseBody, T> nextResponseBodyConverter(@Nullable Converter.Factory factory, Type type, Annotation[] annotationArr) {
        ...
        int size = this.converterFactories.size();
        for (int i8 = indexOf; i8 < size; i8++) {
            Converter<ResponseBody, T> converter = (Converter<ResponseBody, T>) this.converterFactories.get(i8).responseBodyConverter(type, annotationArr, this);
            if (converter != null) {
                return converter;
            }
        }
    ...
    public <T> Converter<T, String> stringConverter(Type type, Annotation[] annotationArr) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            Converter<T, String> converter = (Converter<T, String>) this.converterFactories.get(i8).stringConverter(type, annotationArr, this);
            if (converter != null) {
                return converter;
            }
        }
    ...
    public static final class Builder {
        ...
        Builder(Retrofit retrofit) {
            ...
            for (int i8 = 1; i8 < size; i8++) {
                this.converterFactories.add(retrofit.converterFactories.get(i8));
            }
            int size2 = retrofit.callAdapterFactories.size() - this.platform.defaultCallAdapterFactoriesSize();
            for (int i9 = 0; i9 < size2; i9++) {
                this.callAdapterFactories.add(retrofit.callAdapterFactories.get(i9));
            }
