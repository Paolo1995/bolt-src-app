...
public final class SslUtils {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void handleHandshakeFailure(ChannelHandlerContext channelHandlerContext, Throwable th, boolean z7) {
    ...
    public static boolean isValidHostNameForSNI(String str) {
        if (str != null && str.indexOf(46) > 0 && !str.endsWith(".") && !NetUtil.isValidIpV4Address(str) && !NetUtil.isValidIpV6Address(str)) {
            return true;
        }
        return false;
    }

    private static short shortBE(ByteBuf byteBuf, int i8) {
        return byteBuf.order() == ByteOrder.BIG_ENDIAN ? byteBuf.getShort(i8) : byteBuf.getShortLE(i8);
    }
    ...
    private static int unsignedShortBE(ByteBuf byteBuf, int i8) {
        return byteBuf.order() == ByteOrder.BIG_ENDIAN ? byteBuf.getUnsignedShort(i8) : byteBuf.getUnsignedShortLE(i8);
    }
    ...
    private static short shortBE(ByteBuffer byteBuffer, int i8) {
        return byteBuffer.order() == ByteOrder.BIG_ENDIAN ? byteBuffer.getShort(i8) : ByteBufUtil.swapShort(byteBuffer.getShort(i8));
    }

    private static int unsignedShortBE(ByteBuffer byteBuffer, int i8) {
        return shortBE(byteBuffer, i8) & 65535;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getEncryptedPacketLength(ByteBuffer[] byteBufferArr, int i8) {
        ...
        while (true) {
            int i9 = i8 + 1;
            ByteBuffer duplicate = byteBufferArr[i8].duplicate();
