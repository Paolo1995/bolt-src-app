...
public final class OpenSslCachingX509KeyManagerFactory extends KeyManagerFactory {
    ...
    public OpenSslCachingX509KeyManagerFactory(KeyManagerFactory keyManagerFactory) {
        this(keyManagerFactory, Spliterator.IMMUTABLE);
    }
    ...
    public OpenSslCachingX509KeyManagerFactory(final KeyManagerFactory keyManagerFactory, int i8) {
        ...
        this.maxCachedEntries = ObjectUtil.checkPositive(i8, "maxCachedEntries");
    }
}
