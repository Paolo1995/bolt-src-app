...
public class ChannelOption<T> extends AbstractConstant<ChannelOption<T>> {
    private static final ConstantPool<ChannelOption<Object>> pool = new ConstantPool<ChannelOption<Object>>() { // from class: io.netty.channel.ChannelOption.1
        ...
        public ChannelOption<Object> newConstant(int i8, String str) {
    ...
    public void validate(T t7) {
        ObjectUtil.checkNotNull(t7, AppMeasurementSdk.ConditionalUserProperty.VALUE);
    }
