                ...
                if (readerIndex2 < h8) {
                    ...
                    if (readableBytes != 0) {
                        ...
                        for (int i9 = 0; i9 < readableBytes; i9++) {
                            Mqtt5SubAckReasonCode c8 = Mqtt5SubAckReasonCode.c(byteBuf.readUnsignedByte());
                            if (c8 != null) {
                                w7.a(c8);
                            } else {
                        ...
                        return new MqttSubAck(readUnsignedShort, w7.b(), mqttUtf8StringImpl, MqttUserPropertiesImpl.b(builder));
                    }
