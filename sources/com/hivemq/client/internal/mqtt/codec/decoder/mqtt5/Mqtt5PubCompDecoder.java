...
public class Mqtt5PubCompDecoder implements MqttMessageDecoder {
    ...
    public MqttPubComp a(int i8, ByteBuf byteBuf, MqttDecoderContext mqttDecoderContext) throws MqttDecoderException {
        ...
        if (byteBuf.readableBytes() >= 2) {
            ...
            Mqtt5PubCompReasonCode mqtt5PubCompReasonCode = MqttPubComp.f18583f;
            ImmutableList.Builder<MqttUserPropertyImpl> builder = null;
            MqttUtf8StringImpl mqttUtf8StringImpl2 = null;
            if (byteBuf.isReadable()) {
                mqtt5PubCompReasonCode = Mqtt5PubCompReasonCode.c(byteBuf.readUnsignedByte());
                if (mqtt5PubCompReasonCode != null) {
                    if (byteBuf.isReadable()) {
                        ...
                        builder = builder2;
                        return new MqttPubComp(readUnsignedShort, mqtt5PubCompReasonCode, mqttUtf8StringImpl, MqttUserPropertiesImpl.b(builder));
                    }
                } else {
