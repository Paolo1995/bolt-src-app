...
public final class Protobuf {
    ...
    private static final Protobuf f15187c = new Protobuf();

    /* renamed from: b  reason: collision with root package name */
    private final ConcurrentMap<Class<?>, Schema<?>> f15189b = new ConcurrentHashMap();

    /* renamed from: a  reason: collision with root package name */
    private final SchemaFactory f15188a = new ManifestSchemaFactory();
    ...
    public Schema<?> c(Class<?> cls, Schema<?> schema) {
        ...
        return this.f15189b.putIfAbsent(cls, schema);
    }

    public <T> Schema<T> d(Class<T> cls) {
        Internal.b(cls, "messageType");
        Schema<T> schema = (Schema<T>) this.f15189b.get(cls);
        if (schema == null) {
            Schema<T> a8 = this.f15188a.a(cls);
