...
public abstract class ListFieldSchema {
    ...
    private static final ListFieldSchema f15146a = new ListFieldSchemaFull();

    /* renamed from: b  reason: collision with root package name */
    private static final ListFieldSchema f15147b = new ListFieldSchemaLite();

    /* loaded from: classes.dex */
    private static final class ListFieldSchemaFull extends ListFieldSchema {

        /* renamed from: c  reason: collision with root package name */
        private static final Class<?> f15148c = Collections.unmodifiableList(Collections.emptyList()).getClass();
        ...
        private static <L> List<L> g(Object obj, long j8, int i8) {
            ...
            if (f8.isEmpty()) {
                ...
                UnsafeUtil.O(obj, j8, arrayList);
                return arrayList;
            }
            if (f15148c.isAssignableFrom(f8.getClass())) {
                ArrayList arrayList2 = new ArrayList(f8.size() + i8);
                arrayList2.addAll(f8);
                UnsafeUtil.O(obj, j8, arrayList2);
                ...
                UnsafeUtil.O(obj, j8, lazyStringArrayList2);
        ...
        void c(Object obj, long j8) {
            ...
            List list = (List) UnsafeUtil.A(obj, j8);
            if (list instanceof LazyStringList) {
                unmodifiableList = ((LazyStringList) list).j();
            } else if (f15148c.isAssignableFrom(list.getClass())) {
                return;
            } else {
            ...
            UnsafeUtil.O(obj, j8, unmodifiableList);
        }
    ...
    private static final class ListFieldSchemaLite extends ListFieldSchema {
        ...
        static <E> Internal.ProtobufList<E> f(Object obj, long j8) {
            return (Internal.ProtobufList) UnsafeUtil.A(obj, j8);
        }
