...
public interface Reader {
    ...
    @Deprecated
    <T> T J(Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    @Deprecated
    <T> T K(Class<T> cls, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <K, V> void L(Map<K, V> map, MapEntryLite.Metadata<K, V> metadata, ExtensionRegistryLite extensionRegistryLite) throws IOException;
