...
public interface Writer {
    ...
    <K, V> void J(int i8, MapEntryLite.Metadata<K, V> metadata, Map<K, V> map) throws IOException;

    @Deprecated
    void K(int i8, Object obj, Schema schema) throws IOException;

    void L(int i8, List<?> list, Schema schema) throws IOException;

    void M(int i8, ByteString byteString) throws IOException;

    void N(int i8, Object obj, Schema schema) throws IOException;

    @Deprecated
    void O(int i8, List<?> list, Schema schema) throws IOException;
