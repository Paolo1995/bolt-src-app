...
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter<T> {
    ...
    public static abstract class DateType<T extends Date> {
        ...
        public final TypeAdapterFactory createAdapterFactory(int i8) {
            return createFactory(new DefaultDateTypeAdapter<>(this, i8));
        }

        public final TypeAdapterFactory createAdapterFactory(int i8, int i9) {
            return createFactory(new DefaultDateTypeAdapter<>(this, i8, i9));
        }
    }
    ...
    private Date deserializeToDate(JsonReader jsonReader) throws IOException {
        ...
        synchronized (this.dateFormats) {
            ...
            try {
                ...
                throw new JsonSyntaxException("Failed parsing '" + nextString + "' as Date; at path " + jsonReader.getPreviousPath(), e8);
            }
        }
    }
    ...
    private DefaultDateTypeAdapter(DateType<T> dateType, int i8) {
        ArrayList arrayList = new ArrayList();
        this.dateFormats = arrayList;
        Objects.requireNonNull(dateType);
        this.dateType = dateType;
        ...
        if (JavaVersion.isJava9OrLater()) {
            arrayList.add(PreJava9DateFormatProvider.getUSDateFormat(i8));
        }
    }

    private DefaultDateTypeAdapter(DateType<T> dateType, int i8, int i9) {
        ArrayList arrayList = new ArrayList();
        this.dateFormats = arrayList;
        Objects.requireNonNull(dateType);
        this.dateType = dateType;
