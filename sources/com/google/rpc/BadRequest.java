...
public final class BadRequest extends GeneratedMessageLite<BadRequest, Builder> implements MessageLiteOrBuilder {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f17711a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f17711a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f17711a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f17711a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f17711a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f17711a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    /* loaded from: classes3.dex */
    public static final class Builder extends GeneratedMessageLite.Builder<BadRequest, Builder> implements MessageLiteOrBuilder {
    ...
    public static final class FieldViolation extends GeneratedMessageLite<FieldViolation, Builder> implements FieldViolationOrBuilder {
        ...
        public void setFieldBytes(ByteString byteString) {
            AbstractMessageLite.checkByteStringIsUtf8(byteString);
            this.field_ = byteString.L();
        }

        @Override // com.google.protobuf.GeneratedMessageLite
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (AnonymousClass1.f17711a[methodToInvoke.ordinal()]) {
                case 1:
        ...
        public ByteString getFieldBytes() {
            return ByteString.r(this.field_);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void removeFieldViolations(int i8) {
        ensureFieldViolationsIsMutable();
        this.fieldViolations_.remove(i8);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void setFieldViolations(int i8, FieldViolation fieldViolation) {
        fieldViolation.getClass();
        ensureFieldViolationsIsMutable();
        this.fieldViolations_.set(i8, fieldViolation);
    }
    ...
    public FieldViolation getFieldViolations(int i8) {
    ...
    public FieldViolationOrBuilder getFieldViolationsOrBuilder(int i8) {
        return this.fieldViolations_.get(i8);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void addFieldViolations(int i8, FieldViolation fieldViolation) {
        fieldViolation.getClass();
        ensureFieldViolationsIsMutable();
        this.fieldViolations_.add(i8, fieldViolation);
    }
