...
class SettingsV3JsonTransform implements SettingsJsonTransform {
    ...
    private static long d(CurrentTimeProvider currentTimeProvider, long j8, JSONObject jSONObject) {
        if (jSONObject.has("expires_at")) {
            return jSONObject.optLong("expires_at");
        }
        return currentTimeProvider.a() + (j8 * 1000);
    }

    @Override // com.google.firebase.crashlytics.internal.settings.SettingsJsonTransform
    public Settings a(CurrentTimeProvider currentTimeProvider, JSONObject jSONObject) throws JSONException {
        Settings.SessionData c8;
        ...
        return new Settings(d(currentTimeProvider, optInt2, jSONObject), c8, b(jSONObject.getJSONObject("features")), optInt, optInt2, optDouble, optDouble2, optInt3);
    }
}
