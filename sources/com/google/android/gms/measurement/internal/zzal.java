        ...
        if (zzkpVar.zzc(3600000L)) {
            try {
                ...
                try {
                    ...
                    this.zza.zzs.zzay().zzd().zzb("Failed to open freshly created database", e8);
                    throw e8;
                }
            }
        }
