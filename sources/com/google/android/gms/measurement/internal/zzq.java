...
public final class zzq extends AbstractSafeParcelable {
    ...
    public zzq(@SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) String str2, @SafeParcelable.Param(id = 4) String str3, @SafeParcelable.Param(id = 5) String str4, @SafeParcelable.Param(id = 6) long j8, @SafeParcelable.Param(id = 7) long j9, @SafeParcelable.Param(id = 8) String str5, @SafeParcelable.Param(id = 9) boolean z7, @SafeParcelable.Param(id = 10) boolean z8, @SafeParcelable.Param(id = 11) long j10, @SafeParcelable.Param(id = 12) String str6, @SafeParcelable.Param(id = 13) long j11, @SafeParcelable.Param(id = 14) long j12, @SafeParcelable.Param(id = 15) int i8, @SafeParcelable.Param(id = 16) boolean z9, @SafeParcelable.Param(id = 18) boolean z10, @SafeParcelable.Param(id = 19) String str7, @SafeParcelable.Param(id = 21) Boolean bool, @SafeParcelable.Param(id = 22) long j13, @SafeParcelable.Param(id = 23) List list, @SafeParcelable.Param(id = 24) String str8, @SafeParcelable.Param(id = 25) String str9, @SafeParcelable.Param(id = 26) String str10, @SafeParcelable.Param(id = 27) String str11) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = str3;
        this.zzj = j10;
