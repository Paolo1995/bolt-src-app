...
public interface zzik {
    ...
    Map zzo(String str, String str2, boolean z7);
    ...
    void zzt(String str, String str2, Bundle bundle, long j8);

    void zzu(zzhf zzhfVar);

    void zzv(Bundle bundle);

    void zzw(zzhe zzheVar);

    void zzx(zzhf zzhfVar);
}
