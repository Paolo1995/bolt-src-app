...
public interface zzek extends IInterface {
    ...
    List zze(zzq zzqVar, boolean z7) throws RemoteException;
    ...
    List zzh(String str, String str2, boolean z7, zzq zzqVar) throws RemoteException;

    List zzi(String str, String str2, String str3, boolean z7) throws RemoteException;
    ...
    void zzq(long j8, String str, String str2, String str3) throws RemoteException;
