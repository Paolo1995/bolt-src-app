...
public class AccountTransferClient extends GoogleApi<zzq> {
    ...
    public AccountTransferClient(@NonNull Activity activity, zzq zzqVar) {
    ...
    @NonNull
    public Task<Void> notifyCompletion(@NonNull String str, int i8) {
        Preconditions.checkNotNull(str);
        return doWrite(new zzi(this, 1610, new zzav(str, i8)));
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AccountTransferClient(@NonNull Context context, zzq zzqVar) {
