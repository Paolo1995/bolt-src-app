...
public final class zbb implements Runnable {
    ...
    public final void run() {
        ...
        try {
            ...
            zba.e("IOException when revoking access: ".concat(String.valueOf(e8.toString())), new Object[0]);
        } catch (Exception e9) {
            zba.e("Exception when revoking access: ".concat(String.valueOf(e9.toString())), new Object[0]);
        }
