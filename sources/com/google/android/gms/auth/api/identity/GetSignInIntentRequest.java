...
public class GetSignInIntentRequest extends AbstractSafeParcelable {
    ...
    public static final class Builder {
        ...
        @NonNull
        public final Builder zba(boolean z7) {
            this.zbe = z7;
            return this;
        }
        ...
        @NonNull
        public final Builder zbc(int i8) {
            this.zbf = i8;
            return this;
        }
    }
    ...
    public GetSignInIntentRequest(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) String str2, @SafeParcelable.Param(id = 3) String str3, @SafeParcelable.Param(id = 4) String str4, @SafeParcelable.Param(id = 5) boolean z7, @SafeParcelable.Param(id = 6) int i8) {
        Preconditions.checkNotNull(str);
        this.zba = str;
        this.zbb = str2;
        this.zbc = str3;
    ...
    public void writeToParcel(@NonNull Parcel parcel, int i8) {
        ...
        SafeParcelWriter.writeBoolean(parcel, 5, this.zbe);
