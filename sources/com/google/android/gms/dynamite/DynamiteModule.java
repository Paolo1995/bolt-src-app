...
public final class DynamiteModule {
    ...
    public interface VersionPolicy {
        ...
        public interface IVersions {
            ...
            int zzb(@NonNull Context context, @NonNull String str, boolean z7) throws LoadingException;
        }
    ...
    public static DynamiteModule load(@NonNull Context context, @NonNull VersionPolicy versionPolicy, @NonNull String str) throws LoadingException {
        ...
        try {
                                        ...
                                        if (zzrVar != null) {
                                            ...
                                            if (zznVar3 != null && zznVar3.zza != null) {
                                                ...
                                                if (valueOf.booleanValue()) {
                                                    ...
                                                    zze2 = zzrVar.zzf(ObjectWrapper.wrap(applicationContext), str, i11, ObjectWrapper.wrap(cursor2));
                                                } else {
                                                    Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to loadModule2");
                                                    zze2 = zzrVar.zze(ObjectWrapper.wrap(applicationContext), str, i11, ObjectWrapper.wrap(cursor2));
                                                }
            ...
            throw new LoadingException("No acceptable module " + str + " found. Local version is " + i13 + " and remote version is " + i14 + ".", null);
        } catch (Throwable th2) {
            if (longValue == 0) {
                zzh.remove();
            } else {
    ...
    public static int zza(@NonNull Context context, @NonNull String str, boolean z7) {
        Field declaredField;
        Throwable th;
        RemoteException e8;
        Cursor cursor;
        try {
            synchronized (DynamiteModule.class) {
                        ...
                        if (classLoader == ClassLoader.getSystemClassLoader()) {
                            ...
                            if (!zzd) {
                                ...
                                if (!bool2.equals(null)) {
                                    try {
                                        int zzb2 = zzb(context, str, z7, true);
                                        String str2 = zzc;
                ...
                if (bool.booleanValue()) {
                    try {
                        return zzb(context, str, z7, false);
                    } catch (LoadingException e10) {
                        String message = e10.getMessage();
                        ...
                        try {
                            ...
                            if (zze2 >= 3) {
                                ...
                                if (zznVar != null && (cursor = zznVar.zza) != null) {
                                    ...
                                    Cursor cursor3 = (Cursor) ObjectWrapper.unwrap(zzg2.zzk(ObjectWrapper.wrap(context), str, z7, ((Long) zzh.get()).longValue()));
                                    if (cursor3 != null) {
                                        try {
                                ...
                                i8 = zzg2.zzg(ObjectWrapper.wrap(context), str, z7);
                            } else {
                                Log.w("DynamiteModule", "IDynamite loader version < 2, falling back to getModuleVersion2");
                                i8 = zzg2.zzf(ObjectWrapper.wrap(context), str, z7);
                            }
