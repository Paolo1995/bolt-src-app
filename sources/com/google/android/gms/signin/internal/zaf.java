...
public final class zaf extends com.google.android.gms.internal.base.zaa {
    ...
    public final void zae(int i8) throws RemoteException {
        Parcel zaa = zaa();
        zaa.writeInt(i8);
        zac(7, zaa);
    }

    public final void zaf(IAccountAccessor iAccountAccessor, int i8, boolean z7) throws RemoteException {
        Parcel zaa = zaa();
        com.google.android.gms.internal.base.zac.zae(zaa, iAccountAccessor);
        zaa.writeInt(i8);
        com.google.android.gms.internal.base.zac.zac(zaa, z7);
        zac(9, zaa);
    }
