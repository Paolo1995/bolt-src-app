...
public class FusedLocationProviderClient extends GoogleApi<Api.ApiOptions.NoOptions> {
    ...
    private final Task<Void> zze(final com.google.android.gms.internal.location.zzba zzbaVar, final LocationCallback locationCallback, Looper looper, final zzan zzanVar, int i8) {
        ...
        }).unregister(zzakVar).withHolder(createListenerHolder).setMethodKey(i8).build());
    }
    ...
    @RecentlyNonNull
    public Task<Location> getCurrentLocation(int i8, @RecentlyNonNull final CancellationToken cancellationToken) {
        LocationRequest create = LocationRequest.create();
        create.setPriority(i8);
        create.setInterval(0L);
        create.setFastestInterval(0L);
        create.setExpirationDuration(DefaultCallController.ICE_SERVERS_VALID_WINDOW_MS);
