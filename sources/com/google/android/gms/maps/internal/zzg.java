...
public final class zzg extends com.google.android.gms.internal.maps.zza implements IGoogleMapDelegate {
    ...
    @Override // com.google.android.gms.maps.internal.IGoogleMapDelegate
    public final void animateCameraWithDurationAndCallback(IObjectWrapper iObjectWrapper, int i8, zzd zzdVar) throws RemoteException {
        Parcel zza = zza();
        com.google.android.gms.internal.maps.zzc.zzg(zza, iObjectWrapper);
        zza.writeInt(i8);
        com.google.android.gms.internal.maps.zzc.zzg(zza, zzdVar);
    ...
    public final IProjectionDelegate getProjection() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            if (queryLocalInterface instanceof IProjectionDelegate) {
                zzbtVar = (IProjectionDelegate) queryLocalInterface;
            } else {
                zzbtVar = new zzbt(readStrongBinder);
            }
        }
        zzH.recycle();
        return zzbtVar;
    ...
    public final void setBuildingsEnabled(boolean z7) throws RemoteException {
        Parcel zza = zza();
        com.google.android.gms.internal.maps.zzc.zzd(zza, z7);
        zzc(41, zza);
    }
    ...
    @Override // com.google.android.gms.maps.internal.IGoogleMapDelegate
    public final void setMaxZoomPreference(float f8) throws RemoteException {
        Parcel zza = zza();
        zza.writeFloat(f8);
        zzc(93, zza);
    }
    ...
    @Override // com.google.android.gms.maps.internal.IGoogleMapDelegate
    public final void setMinZoomPreference(float f8) throws RemoteException {
        Parcel zza = zza();
        zza.writeFloat(f8);
        zzc(92, zza);
    }
    ...
    @Override // com.google.android.gms.maps.internal.IGoogleMapDelegate
    public final void setPadding(int i8, int i9, int i10, int i11) throws RemoteException {
        Parcel zza = zza();
        zza.writeInt(i8);
        zza.writeInt(i9);
        zza.writeInt(i10);
