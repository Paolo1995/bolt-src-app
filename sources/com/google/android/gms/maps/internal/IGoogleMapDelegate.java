...
public interface IGoogleMapDelegate extends IInterface {
    ...
    void animateCameraWithDurationAndCallback(IObjectWrapper iObjectWrapper, int i8, @Nullable zzd zzdVar) throws RemoteException;
    ...
    void setMaxZoomPreference(float f8) throws RemoteException;

    void setMinZoomPreference(float f8) throws RemoteException;
    ...
    void setPadding(int i8, int i9, int i10, int i11) throws RemoteException;
