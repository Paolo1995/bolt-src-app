...
public final class zzal implements WorkAccountApi {
    ...
    @Override // com.google.android.gms.auth.account.WorkAccountApi
    public final void setWorkAuthenticatorEnabled(GoogleApiClient googleApiClient, boolean z7) {
        setWorkAuthenticatorEnabledWithResult(googleApiClient, z7);
    }

    @Override // com.google.android.gms.auth.account.WorkAccountApi
    public final PendingResult<Result> setWorkAuthenticatorEnabledWithResult(GoogleApiClient googleApiClient, boolean z7) {
        return googleApiClient.execute(new zzac(this, WorkAccount.API, googleApiClient, z7));
    }
}
