...
public final class zzhm implements zzhk {
    ...
    static {
        ...
        zzc = zza2.zzc("getTokenRefactor__account_manager_timeout_seconds", 20L);
        zzd = zza2.zzc("getTokenRefactor__android_id_shift", 0L);
        ...
        try {
            ...
            zzh = zza2.zzc("getTokenRefactor__clear_token_timeout_seconds", 20L);
            zzi = zza2.zzc("getTokenRefactor__default_task_timeout_seconds", 20L);
            ...
            zzl = zza2.zzc("getTokenRefactor__get_token_timeout_seconds", 120L);
            ...
            throw new AssertionError("Could not parse proto flag \"getTokenRefactor__blocked_packages\"", e8);
        }
    }
