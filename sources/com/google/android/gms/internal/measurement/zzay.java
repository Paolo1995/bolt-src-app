...
public final class zzay extends zzaw {
    ...
    private static boolean zzc(zzap zzapVar, zzap zzapVar2) {
        if (zzapVar.getClass().equals(zzapVar2.getClass())) {
            ...
            boolean z7 = zzapVar instanceof zzah;
            if (z7 && (zzapVar2 instanceof zzat)) {
                return zzc(zzapVar, new zzah(zzapVar2.zzh()));
            }
            boolean z8 = zzapVar instanceof zzat;
            if (z8 && (zzapVar2 instanceof zzah)) {
            ...
            if ((!z8 && !z7) || !(zzapVar2 instanceof zzal)) {
    ...
    private static boolean zzd(zzap zzapVar, zzap zzapVar2) {
        ...
        if (!Double.isNaN(doubleValue) && !Double.isNaN(doubleValue2) && ((doubleValue != 0.0d || doubleValue2 != 0.0d) && ((i8 != 0 || doubleValue2 != 0.0d) && Double.compare(doubleValue, doubleValue2) < 0))) {
            return true;
        }
        return false;
    }
