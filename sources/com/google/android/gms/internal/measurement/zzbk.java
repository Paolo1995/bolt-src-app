        ...
        if (ordinal == 3) {
            ...
            if (list.size() % 2 == 0) {
                for (int i9 = 0; i9 < list.size() - 1; i9 += 2) {
                    zzap zzb3 = zzgVar.zzb((zzap) list.get(i9));
                    if (zzb3 instanceof zzat) {
                        zzgVar.zzf(zzb3.zzi(), zzgVar.zzb((zzap) list.get(i9 + 1)));
                    } else {
            ...
            while (i8 < list.size()) {
                zzapVar = zzgVar.zzb((zzap) list.get(i8));
            ...
            if (list.size() % 2 == 0) {
                ...
                while (i8 < list.size() - 1) {
                    zzap zzb9 = zzgVar.zzb((zzap) list.get(i8));
                    zzap zzb10 = zzgVar.zzb((zzap) list.get(i8 + 1));
            ...
            if (zzb13 instanceof zzat) {
                if (Name.LENGTH.equals(zzb14.zzi())) {
