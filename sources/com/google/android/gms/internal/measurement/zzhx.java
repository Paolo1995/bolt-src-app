...
public final class zzhx {
    ...
    private zzhx(String str, Uri uri, String str2, String str3, boolean z7, boolean z8, boolean z9, boolean z10, @Nullable zzie zzieVar) {
        this.zza = null;
        this.zzb = uri;
        this.zzc = "";
        this.zzd = "";
    ...
    public final zzia zzc(String str, double d8) {
        return new zzhv(this, "measurement.test.double_flag", Double.valueOf(-3.0d), true);
    }

    public final zzia zzd(String str, long j8) {
        return new zzht(this, str, Long.valueOf(j8), true);
    }
    ...
    public final zzia zzf(String str, boolean z7) {
        return new zzhu(this, str, Boolean.valueOf(z7), true);
    }
}
