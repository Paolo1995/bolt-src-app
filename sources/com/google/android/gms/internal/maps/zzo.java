...
public interface zzo extends IInterface {
    ...
    void zzq(float f8) throws RemoteException;

    void zzr(float f8, float f9) throws RemoteException;
    ...
    void zzw(float f8) throws RemoteException;

    void zzx(boolean z7) throws RemoteException;

    void zzy(float f8) throws RemoteException;

    boolean zzz(zzo zzoVar) throws RemoteException;
}
