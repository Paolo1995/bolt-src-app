...
public interface zzag extends IInterface {
    void zzA(boolean z7) throws RemoteException;

    void zzB(float f8) throws RemoteException;

    void zzC(float f8) throws RemoteException;

    boolean zzD(@Nullable zzag zzagVar) throws RemoteException;
    ...
    void zzr(int i8) throws RemoteException;

    void zzs(Cap cap) throws RemoteException;

    void zzt(boolean z7) throws RemoteException;
