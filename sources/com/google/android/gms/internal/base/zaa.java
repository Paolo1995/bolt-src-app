...
public class zaa implements IInterface {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final Parcel zab(int i8, Parcel parcel) throws RemoteException {
        Parcel obtain = Parcel.obtain();
        try {
            try {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final void zac(int i8, Parcel parcel) throws RemoteException {
        Parcel obtain = Parcel.obtain();
        try {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final void zad(int i8, Parcel parcel) throws RemoteException {
        try {
