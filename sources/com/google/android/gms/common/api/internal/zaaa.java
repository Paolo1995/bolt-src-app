...
public final class zaaa implements zaca {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* bridge */ /* synthetic */ void zan(zaaa zaaaVar, int i8, boolean z7) {
        zaaaVar.zab.zac(i8, z7);
        zaaaVar.zak = null;
        zaaaVar.zaj = null;
    }
    ...
    @Override // com.google.android.gms.common.api.internal.zaca
    @GuardedBy("mLock")
    public final ConnectionResult zac(long j8, @NonNull TimeUnit timeUnit) {
        throw new UnsupportedOperationException();
    }
