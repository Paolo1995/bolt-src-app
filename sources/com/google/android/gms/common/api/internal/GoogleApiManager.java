...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final void zaL(TaskCompletionSource taskCompletionSource, int i8, GoogleApi googleApi) {
        zacd zaa2;
        if (i8 != 0 && (zaa2 = zacd.zaa(this, i8, googleApi.getApiKey())) != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final boolean zaG(ConnectionResult connectionResult, int i8) {
        return this.zal.zah(this.zak, connectionResult, i8);
    }
    ...
    @NonNull
    public final Task zar(@NonNull GoogleApi googleApi, @NonNull ListenerHolder.ListenerKey listenerKey, int i8) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        zaL(taskCompletionSource, i8, googleApi);
    ...
    public final void zaw(@NonNull GoogleApi googleApi, int i8, @NonNull BaseImplementation.ApiMethodImpl apiMethodImpl) {
        zae zaeVar = new zae(i8, apiMethodImpl);
        Handler handler = this.zat;
        handler.sendMessage(handler.obtainMessage(4, new zach(zaeVar, this.zao.get(), googleApi)));
    }

    public final void zax(@NonNull GoogleApi googleApi, int i8, @NonNull TaskApiCall taskApiCall, @NonNull TaskCompletionSource taskCompletionSource, @NonNull StatusExceptionMapper statusExceptionMapper) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final void zay(MethodInvocation methodInvocation, int i8, long j8, int i9) {
        Handler handler = this.zat;
        handler.sendMessage(handler.obtainMessage(18, new zace(methodInvocation, i8, j8, i9)));
    }

    public final void zaz(@NonNull ConnectionResult connectionResult, int i8) {
        if (!zaG(connectionResult, i8)) {
            Handler handler = this.zat;
