...
public abstract class zap extends LifecycleCallback implements DialogInterface.OnCancelListener {
    ...
    public final void zaa(ConnectionResult connectionResult, int i8) {
        this.zab.set(null);
        zab(connectionResult, i8);
    }
    ...
    public final void onActivityResult(int i8, int i9, Intent intent) {
        ...
        if (i8 != 1) {
            ...
            zaa(new ConnectionResult(i10, null, zamVar.zab().toString()), zae(zamVar));
            return;
        }
        if (zamVar != null) {
    ...
    protected abstract void zab(ConnectionResult connectionResult, int i8);
    ...
    public final void zah(ConnectionResult connectionResult, int i8) {
        ...
        AtomicReference atomicReference = this.zab;
        while (!e.a(atomicReference, null, zamVar)) {
