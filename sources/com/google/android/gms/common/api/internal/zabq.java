...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    private final void zaE(Status status, Exception exc, boolean z7) {
        Handler handler;
        boolean z8;
        handler = this.zaa.zat;
        Preconditions.checkHandlerThread(handler);
    ...
    public final void zaH(int i8) {
        ...
        zan();
        this.zaj = true;
        this.zae.zae(i8, this.zac.getLastDisconnectMessage());
    ...
    public final boolean zaN(boolean z7) {
        Handler handler;
        handler = this.zaa.zat;
        Preconditions.checkHandlerThread(handler);
    ...
    public static /* bridge */ /* synthetic */ boolean zax(zabq zabqVar, boolean z7) {
    ...
    public final void onConnectionSuspended(int i8) {
        ...
        handler2 = this.zaa.zat;
        handler2.post(new zabn(this, i8));
    }
