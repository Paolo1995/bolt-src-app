...
public abstract class PendingResult<R extends Result> {
    ...
    @NonNull
    public abstract R await(long j8, @NonNull TimeUnit timeUnit);
    ...
    public abstract void setResultCallback(@NonNull ResultCallback<? super R> resultCallback, long j8, @NonNull TimeUnit timeUnit);
