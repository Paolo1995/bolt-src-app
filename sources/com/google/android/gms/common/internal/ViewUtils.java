...
public class ViewUtils {
    ...
    @KeepForSdk
    public static String getXmlAttributeString(@NonNull String str, @NonNull String str2, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z7, boolean z8, @NonNull String str3) {
        ...
        if (attributeValue != null && attributeValue.startsWith("@string/") && z7) {
