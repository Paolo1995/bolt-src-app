...
public final class SafeParcelableSerializer {
    ...
    public static <T extends SafeParcelable> ArrayList<T> deserializeIterableFromBundle(@NonNull Bundle bundle, @NonNull String str, @NonNull Parcelable.Creator<T> creator) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            arrayList2.add(deserializeFromBytes((byte[]) arrayList.get(i8), creator));
        }
        return arrayList2;
    }
    ...
    public static <T extends SafeParcelable> ArrayList<T> deserializeIterableFromBytes(byte[] bArr, @NonNull Parcelable.Creator<T> creator) {
        if (bArr == null) {
            return null;
        }
    ...
    public static <T extends SafeParcelable> void serializeIterableToBundle(@NonNull Iterable<T> iterable, @NonNull Bundle bundle, @NonNull String str) {
        ...
        for (T t7 : iterable) {
            arrayList.add(serializeToBytes(t7));
        }
    ...
    @NonNull
    @KeepForSdk
    public static <T extends SafeParcelable> byte[] serializeToBytes(@NonNull T t7) {
        Parcel obtain = Parcel.obtain();
    ...
    @KeepForSdk
    public static <T extends SafeParcelable> void serializeToIntentExtra(@NonNull T t7, @NonNull Intent intent, @NonNull String str) {
        intent.putExtra(str, serializeToBytes(t7));
    }

    @NonNull
    @KeepForSdk
    public static <T extends SafeParcelable> String serializeToString(@NonNull T t7) {
        return Base64Utils.encodeUrlSafe(serializeToBytes(t7));
    }
