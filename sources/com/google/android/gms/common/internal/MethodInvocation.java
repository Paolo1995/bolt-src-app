...
public class MethodInvocation extends AbstractSafeParcelable {
    ...
    public MethodInvocation(@SafeParcelable.Param(id = 1) int i8, @SafeParcelable.Param(id = 2) int i9, @SafeParcelable.Param(id = 3) int i10, @SafeParcelable.Param(id = 4) long j8, @SafeParcelable.Param(id = 5) long j9, @SafeParcelable.Param(id = 6) String str, @SafeParcelable.Param(id = 7) String str2, @SafeParcelable.Param(id = 8) int i11, @SafeParcelable.Param(id = 9) int i12) {
        this.zaa = i8;
        this.zab = i9;
        this.zac = i10;
        this.zad = j8;
