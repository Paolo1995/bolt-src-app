...
public final class AccountPicker {
    ...
    @NonNull
    @Deprecated
    public static Intent newChooseAccountIntent(Account account, ArrayList<Account> arrayList, String[] strArr, boolean z7, String str, String str2, String[] strArr2, Bundle bundle) {
