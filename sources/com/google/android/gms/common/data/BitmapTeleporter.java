...
public class BitmapTeleporter extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public BitmapTeleporter(@SafeParcelable.Param(id = 1) int i8, @SafeParcelable.Param(id = 2) ParcelFileDescriptor parcelFileDescriptor, @SafeParcelable.Param(id = 3) int i9) {
        this.zaa = i8;
    ...
    public final void writeToParcel(@NonNull Parcel parcel, int i8) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 2, this.zab, i8 | 1, false);
