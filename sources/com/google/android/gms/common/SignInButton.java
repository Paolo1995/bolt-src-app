...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    private final void zaa(Context context) {
        ...
        try {
            ...
            zaaaVar.zaa(context.getResources(), i8, i9);
            this.zac = zaaaVar;
        }
        addView(this.zac);
    ...
    public void setColorScheme(int i8) {
        setStyle(this.zaa, i8);
    }

    @Override // android.view.View
    public void setEnabled(boolean z7) {
        super.setEnabled(z7);
        this.zac.setEnabled(z7);
    }
    ...
    public SignInButton(@NonNull Context context, AttributeSet attributeSet, int i8) {
