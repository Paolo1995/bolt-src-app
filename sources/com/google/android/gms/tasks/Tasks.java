...
public final class Tasks {
    ...
    @NonNull
    public static <T> Task<T> withTimeout(@NonNull Task<T> task, long j8, @NonNull TimeUnit timeUnit) {
        boolean z7;
        Preconditions.checkNotNull(task, "Task must not be null");
        if (j8 > 0) {
            z7 = true;
        ...
        Preconditions.checkArgument(z7, "Timeout must be positive");
    ...
    public static <TResult> TResult await(@NonNull Task<TResult> task, long j8, @NonNull TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        Preconditions.checkNotMainThread();
        Preconditions.checkNotNull(task, "Task must not be null");
        Preconditions.checkNotNull(timeUnit, "TimeUnit must not be null");
        if (task.isComplete()) {
