...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
    ...
    public static final Option<Integer> f10418b = Option.f("com.bumptech.glide.load.resource.bitmap.BitmapEncoder.CompressionQuality", 90);

    /* renamed from: c  reason: collision with root package name */
    public static final Option<Bitmap.CompressFormat> f10419c = Option.e("com.bumptech.glide.load.resource.bitmap.BitmapEncoder.CompressionFormat");

    /* renamed from: a  reason: collision with root package name */
    private final ArrayPool f10420a;

    public BitmapEncoder(@NonNull ArrayPool arrayPool) {
        this.f10420a = arrayPool;
    }

    private Bitmap.CompressFormat d(Bitmap bitmap, Options options) {
        Bitmap.CompressFormat compressFormat = (Bitmap.CompressFormat) options.c(f10419c);
    ...
    */
    public boolean a(@androidx.annotation.NonNull com.bumptech.glide.load.engine.Resource<android.graphics.Bitmap> r9, @androidx.annotation.NonNull java.io.File r10, @androidx.annotation.NonNull com.bumptech.glide.load.Options r11) {
        /*
            r8 = this;
            ...
            long r2 = com.bumptech.glide.util.LogTime.b()     // Catch: java.lang.Throwable -> Lc0
            com.bumptech.glide.load.Option<java.lang.Integer> r4 = com.bumptech.glide.load.resource.bitmap.BitmapEncoder.f10418b     // Catch: java.lang.Throwable -> Lc0
            ...
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r10 = r8.f10420a     // Catch: java.lang.Throwable -> L51 java.io.IOException -> L54
            if (r10 == 0) goto L45
            ...
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r6 = r8.f10420a     // Catch: java.lang.Throwable -> L51 java.io.IOException -> L54
        ...
        L69:
            ...
            r10.append(r1)     // Catch: java.lang.Throwable -> Lc0
            int r1 = com.bumptech.glide.util.Util.h(r9)     // Catch: java.lang.Throwable -> Lc0
            r10.append(r1)     // Catch: java.lang.Throwable -> Lc0
            ...
            r10.append(r1)     // Catch: java.lang.Throwable -> Lc0
            com.bumptech.glide.load.Option<android.graphics.Bitmap$CompressFormat> r1 = com.bumptech.glide.load.resource.bitmap.BitmapEncoder.f10419c     // Catch: java.lang.Throwable -> Lc0
