...
public class ReLinkerInstance {
    ...
    public void loadLibraryInternal(Context context, String str, String str2) {
        ...
        try {
            ...
            log("Loading the library normally failed: %s", Log.getStackTraceString(e8));
    ...
    public void cleanupOldLibFiles(Context context, String str, String str2) {
        ...
        File[] listFiles = workaroundLibDir.listFiles(new FilenameFilter() { // from class: com.sinch.relinker.ReLinkerInstance.2
    ...
    public void loadLibrary(final Context context, final String str, final String str2, final ReLinker.LoadListener loadListener) {
        ...
        if (loadListener == null) {
            ...
            new Thread(new Runnable() { // from class: com.sinch.relinker.ReLinkerInstance.1
                @Override // java.lang.Runnable
                public void run() {
                    try {
                        ReLinkerInstance.this.loadLibraryInternal(context, str, str2);
                        loadListener.success();
                    } catch (MissingLibraryException | UnsatisfiedLinkError e8) {
                        loadListener.failure(e8);
                    }
                }
            }).start();
        }
