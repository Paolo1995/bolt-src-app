...
public abstract class UnsafeAllocator {
    ...
    public static UnsafeAllocator create() {
        try {
            ...
            return new UnsafeAllocator() { // from class: com.sinch.gson.internal.UnsafeAllocator.1
                @Override // com.sinch.gson.internal.UnsafeAllocator
            ...
            try {
                try {
                    ...
                    return new UnsafeAllocator() { // from class: com.sinch.gson.internal.UnsafeAllocator.2
                        @Override // com.sinch.gson.internal.UnsafeAllocator
                        public <T> T newInstance(Class<T> cls2) throws Exception {
                            UnsafeAllocator.assertInstantiable(cls2);
                    ...
                    return new UnsafeAllocator() { // from class: com.sinch.gson.internal.UnsafeAllocator.3
                        @Override // com.sinch.gson.internal.UnsafeAllocator
                        public <T> T newInstance(Class<T> cls2) throws Exception {
                            UnsafeAllocator.assertInstantiable(cls2);
                ...
                return new UnsafeAllocator() { // from class: com.sinch.gson.internal.UnsafeAllocator.4
                    @Override // com.sinch.gson.internal.UnsafeAllocator
