...
public abstract class AppsFlyerLib {
    ...
    public abstract void logLocation(Context context, double d8, double d9);
    ...
    public abstract void setCollectAndroidID(boolean z7);

    public abstract void setCollectIMEI(boolean z7);

    @Deprecated
    public abstract void setCollectOaid(boolean z7);
    ...
    public abstract void setDebugLog(boolean z7);

    public abstract void setDisableAdvertisingIdentifiers(boolean z7);

    public abstract void setDisableNetworkData(boolean z7);
    ...
    public abstract void setIsUpdate(boolean z7);

    public abstract void setLogLevel(AFLogger.LogLevel logLevel);

    public abstract void setMinTimeBetweenSessions(int i8);
    ...
    public abstract void stop(boolean z7, Context context);

    public abstract void subscribeForDeepLink(DeepLinkListener deepLinkListener);

    public abstract void subscribeForDeepLink(DeepLinkListener deepLinkListener, long j8);
    ...
    public abstract void waitForCustomerUserId(boolean z7);
}
