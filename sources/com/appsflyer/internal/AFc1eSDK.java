...
public final class AFc1eSDK implements AFc1cSDK<Map<String, Object>> {
    public static Map<String, Object> values(String str) throws JSONException {
        ...
        try {
            ...
            AFLogger.afErrorLogForExcManagerOnly("error while paring GCD response", e8);
    ...
    public final /* synthetic */ Map<String, Object> valueOf(String str) throws JSONException {
        return values(str);
    }
}
