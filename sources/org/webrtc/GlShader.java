...
public class GlShader {
    ...
    private static int compileShader(int i8, String str) {
    ...
    public void setVertexAttribArray(String str, int i8, int i9, FloatBuffer floatBuffer) {
        if (this.program == -1) {
            throw new RuntimeException("The program has been released");
        }
        int attribLocation = getAttribLocation(str);
        GLES20.glEnableVertexAttribArray(attribLocation);
        GLES20.glVertexAttribPointer(attribLocation, i8, 5126, false, i9, (Buffer) floatBuffer);
        GlUtil.checkNoGLES2Error("setVertexAttribArray");
    }

    public void setVertexAttribArray(String str, int i8, FloatBuffer floatBuffer) {
        setVertexAttribArray(str, i8, 0, floatBuffer);
    }
