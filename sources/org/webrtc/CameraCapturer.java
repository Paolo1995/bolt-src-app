...
abstract class CameraCapturer implements CameraVideoCapturer {
    ...
    public static /* synthetic */ int access$1710(CameraCapturer cameraCapturer) {
        int i8 = cameraCapturer.openAttemptsRemaining;
        cameraCapturer.openAttemptsRemaining = i8 - 1;
        return i8;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void createSessionInternal(int i8) {
        this.uiThreadHandler.postDelayed(this.openCameraTimeoutRunnable, i8 + OPEN_CAMERA_TIMEOUT);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setTorchModeInternal(boolean z7) {
        CameraSession cameraSession;
        Logging.d(TAG, "setTorchModeInternal");
        if (this.sessionOpening || (cameraSession = this.currentSession) == null) {
            return;
        }
        cameraSession.setTorchMode(z7);
    }
    ...
    public void switchCameraInternal(CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler, String str) {
        ...
        synchronized (this.stateLock) {
            ...
            boolean z7 = this.sessionOpening;
            if (!z7 && this.currentSession == null) {
    ...
    public abstract void createCameraSession(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, SurfaceTextureHelper surfaceTextureHelper, String str, int i8, int i9, int i10);
    ...
    @Override // org.webrtc.CameraVideoCapturer
    public void setTorchMode(final boolean z7) {
        Logging.d(TAG, "setTorchMode to " + z7);
        this.cameraThreadHandler.post(new Runnable() { // from class: org.webrtc.CameraCapturer.7
            @Override // java.lang.Runnable
            public void run() {
                CameraCapturer.this.setTorchModeInternal(z7);
            }
        });
    }
    ...
    public void startCapture(int i8, int i9, int i10) {
        Logging.d(TAG, "startCapture: " + i8 + "x" + i9 + "@" + i10);
