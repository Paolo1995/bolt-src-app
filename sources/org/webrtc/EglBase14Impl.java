...
public class EglBase14Impl implements EglBase14 {
    ...
    private static EGLContext createEglContext(EGLContext eGLContext, EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i8) {
    ...
    private static EGLDisplay getEglDisplay() {
        ...
        if (eglGetDisplay == EGL14.EGL_NO_DISPLAY) {
            int eglGetError = EGL14.eglGetError();
            throw new GLException(eglGetError, "Unable to get EGL14 display: 0x" + Integer.toHexString(EGL14.eglGetError()));
        }
        int[] iArr = new int[2];
        ...
        throw new GLException(eglGetError2, "Unable to initialize EGL14: 0x" + Integer.toHexString(EGL14.eglGetError()));
    }

    public static boolean isEGL14Supported() {
        StringBuilder sb = new StringBuilder();
        sb.append("SDK version: ");
        int i8 = CURRENT_SDK_VERSION;
        sb.append(i8);
    ...
    public void createPbufferSurface(int i8, int i9) {
        ...
        EGLSurface eglCreatePbufferSurface = EGL14.eglCreatePbufferSurface(this.eglDisplay, this.eglConfig, new int[]{12375, i8, 12374, i9, 12344}, 0);
        this.eglSurface = eglCreatePbufferSurface;
        if (eglCreatePbufferSurface != EGL14.EGL_NO_SURFACE) {
            return;
        }
        int eglGetError = EGL14.eglGetError();
        throw new GLException(eglGetError, "Failed to create pixel buffer surface with size " + i8 + "x" + i9 + ": 0x" + Integer.toHexString(EGL14.eglGetError()));
    }
