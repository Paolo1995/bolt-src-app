...
public class Logging {
    ...
    public static void log(Severity severity, String str, String str2) {
        ...
        if (loggable != null) {
            ...
            int i8 = AnonymousClass1.$SwitchMap$org$webrtc$Logging$Severity[severity.ordinal()];
            Level level = i8 != 1 ? i8 != 2 ? i8 != 3 ? Level.FINE : Level.INFO : Level.WARNING : Level.SEVERE;
    ...
    private static native void nativeEnableLogToDebugOutput(int i8);

    private static native void nativeLog(int i8, String str, String str2);
