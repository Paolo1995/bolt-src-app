...
public final class WebRtcAudioUtils {
    ...
    public static void assertIsTrue(boolean z7) {
        if (!z7) {
    ...
    @TargetApi(24)
    public static String audioEncodingToString(int i8) {
        if (i8 != 0) {
            switch (i8) {
                case 2:
                    return "PCM_16BIT";
    ...
    @TargetApi(24)
    public static String audioSourceToString(int i8) {
        switch (i8) {
            case 0:
                return "DEFAULT";
            case 1:
    ...
    public static String channelMaskToString(int i8) {
        return i8 != 12 ? i8 != 16 ? "INVALID" : "IN_MONO" : "IN_STEREO";
    }

    public static String deviceTypeToString(int i8) {
        switch (i8) {
            case 1:
