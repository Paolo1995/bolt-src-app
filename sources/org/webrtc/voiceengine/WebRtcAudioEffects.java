...
public class WebRtcAudioEffects {
    ...
    public static boolean canUseAcousticEchoCanceler() {
        boolean z7 = (!isAcousticEchoCancelerSupported() || WebRtcAudioUtils.useWebRtcBasedAcousticEchoCanceler() || isAcousticEchoCancelerBlacklisted() || isAcousticEchoCancelerExcludedByUUID()) ? false : true;
        Logging.d(TAG, "canUseAcousticEchoCanceler: " + z7);
        return z7;
    }

    public static boolean canUseNoiseSuppressor() {
        boolean z7 = (!isNoiseSuppressorSupported() || WebRtcAudioUtils.useWebRtcBasedNoiseSuppressor() || isNoiseSuppressorBlacklisted() || isNoiseSuppressorExcludedByUUID()) ? false : true;
        Logging.d(TAG, "canUseNoiseSuppressor: " + z7);
        return z7;
    }
    ...
    public void enable(int i8) {
        ...
        if (isNoiseSuppressorSupported()) {
            ...
            z7 = (this.shouldEnableNs && canUseNoiseSuppressor()) ? false : false;
