...
class ElementArrayParameter extends TemplateParameter {
    ...
    private static class Contact extends ParameterContact<ElementArray> {
        public Contact(ElementArray elementArray, Constructor constructor, int i8) {
            super(elementArray, constructor, i8);
        }
    ...
    public ElementArrayParameter(Constructor constructor, ElementArray elementArray, Format format, int i8) throws Exception {
        Contact contact = new Contact(elementArray, constructor, i8);
