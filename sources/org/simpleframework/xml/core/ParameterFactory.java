...
class ParameterFactory {
    ...
    public Parameter getInstance(Constructor constructor, Annotation annotation, int i8) throws Exception {
        return getInstance(constructor, annotation, null, i8);
    }

    public Parameter getInstance(Constructor constructor, Annotation annotation, Annotation annotation2, int i8) throws Exception {
        Constructor constructor2 = getConstructor(annotation);
        return annotation2 != null ? (Parameter) constructor2.newInstance(constructor, annotation, annotation2, this.format, Integer.valueOf(i8)) : (Parameter) constructor2.newInstance(constructor, annotation, this.format, Integer.valueOf(i8));
    }
}
