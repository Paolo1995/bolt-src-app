...
class ElementUnionParameter extends TemplateParameter {
    ...
    private static class Contact extends ParameterContact<Element> {
        public Contact(Element element, Constructor constructor, int i8) {
            super(element, constructor, i8);
        }
    ...
    public ElementUnionParameter(Constructor constructor, ElementUnion elementUnion, Element element, Format format, int i8) throws Exception {
        Contact contact = new Contact(element, constructor, i8);
