...
class TreeModel implements Model {
    ...
    private Model create(String str, String str2, int i8) throws Exception {
        TreeModel treeModel = new TreeModel(this.policy, this.detail, str, str2, i8);
        if (str != null) {
    ...
    public TreeModel(Policy policy, Detail detail, String str, String str2, int i8) {
    ...
    @Override // org.simpleframework.xml.core.Model
    public Model register(String str, String str2, int i8) throws Exception {
        Model lookup = this.models.lookup(str, i8);
        return lookup == null ? create(str, str2, i8) : lookup;
    }

    @Override // org.simpleframework.xml.core.Model
    public Model lookup(String str, int i8) {
        return this.models.lookup(str, i8);
    }
}
