...
class ElementListUnionParameter extends TemplateParameter {
    ...
    private static class Contact extends ParameterContact<ElementList> {
        public Contact(ElementList elementList, Constructor constructor, int i8) {
            super(elementList, constructor, i8);
        }
    ...
    public ElementListUnionParameter(Constructor constructor, ElementListUnion elementListUnion, ElementList elementList, Format format, int i8) throws Exception {
        Contact contact = new Contact(elementList, constructor, i8);
