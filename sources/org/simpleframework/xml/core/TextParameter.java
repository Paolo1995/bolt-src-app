...
class TextParameter extends TemplateParameter {
    ...
    private static class Contact extends ParameterContact<Text> {
        public Contact(Text text, Constructor constructor, int i8) {
            super(text, constructor, i8);
        }
    ...
    public TextParameter(Constructor constructor, Text text, Format format, int i8) throws Exception {
        Contact contact = new Contact(text, constructor, i8);
