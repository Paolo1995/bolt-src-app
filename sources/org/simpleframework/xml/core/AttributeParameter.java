...
class AttributeParameter extends TemplateParameter {
    ...
    private static class Contact extends ParameterContact<Attribute> {
        public Contact(Attribute attribute, Constructor constructor, int i8) {
            super(attribute, constructor, i8);
        }
    ...
    public AttributeParameter(Constructor constructor, Attribute attribute, Format format, int i8) throws Exception {
        Contact contact = new Contact(attribute, constructor, i8);
